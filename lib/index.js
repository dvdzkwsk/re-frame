...
// 2. Factory
//
// This should be familiar to redux users coming from React. The factory
// allows users to create stores that are isolated from each other, both in
// state and in event handler registrations. Use this API when you need to
// support multiple (or dynamic) stores.
// --------------------------------------------------------
...
export var registerEffect = SINGLETON.registerEffect
