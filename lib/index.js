...
export const dispatch = SINGLETON.dispatch
export const registerEventDB = SINGLETON.registerEventDB
export const registerEventFX = SINGLETON.registerEventFX
export const registerCoeffect = SINGLETON.registerCoeffect
export const snapshot = SINGLETON.snapshot
